...
export const addFavouritePsychologist = createAsyncThunk(
...
export const removeFavouritePsychologist = createAsyncThunk(
...
export const getFavouritesPsychologists = createAsyncThunk(
    ...
    async (userId, thunkAPI) => {
        try {
            ...
            const favouriteIds = userSnap.data().favourites.map(psychologist => psychologist.id) || []
